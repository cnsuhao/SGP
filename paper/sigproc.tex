...
with Intel i7-3770k cpu at 3.5GHz, and 32GB of main memory. In our synthetic experiments, we use two random graph
models
\begin{table*}[!hpp]
\centering
...
& & & max & min & deviation \\
\hline
label 1-1 & label 1-2 & label 1-3 & label 1 -4 & label 1-5 & label 1-6 & label 1-7\\
label 1-1 & label 1-2 & label 1-3 & label 1 -4 & label 1-5 & label 1-6 & label 1-7\\
\hline
\end{tabular}
\end{table*}
...
In particular, for a fixed partition P we use the measures of the fraction of edges cut ¦Ë
and the normalized maximum load ¦Ñ, defined as
