...
\begin{figure*}[htbp]
    ...
    \caption{Runtime VS. Vertex Order on syn-v4k-e85k Dataset, $k=4$}\label{fig:time-v4k-e85k}
\end{figure*}
...
\begin{figure*}[htbp]
    ...
    \caption{ $\varsigma$ VS. Vertex Order on syn-v4k-e85k Dataset, $k=4$}\label{fig:cut-v4k-e85k}
\end{figure*}
...
\begin{figure*}[htbp]
    ...
    \caption{ $\tau$ VS. Vertex Order on syn-v4k-e85k Dataset, $k=4$}\label{fig:maxload-v4k-e85k}
\end{figure*}
