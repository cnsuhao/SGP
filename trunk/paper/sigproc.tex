...
&\approx& \int_0^{d_v} {\frac{\delta_v}{d_v} \cdot exp(-\frac{s\cdot \delta_v^2}{2d_v})d\delta_v} \notag \\
&=& \int_0^{d_v} {-\frac{1}{s} \cdot \exp(-\frac{s\cdot \delta_v^2}{2d_v})d(-\frac{s\cdot \delta_v^2}{2d_v})} \notag \\
&=& -\frac{1}{s} [\exp(-\frac{s\cdot \delta_v^2}{2d_v})]_0^{d_v} \notag \\
&=& \frac{1}{s} (1-\exp(-\frac{s\cdot d_v}{2})) \notag
\end{eqnarray}
\end{proof}
